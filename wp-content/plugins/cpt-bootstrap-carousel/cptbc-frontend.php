		...
		<div id="cptbc_<?php echo $id; ?>" class="carousel slide" <?php if($atts['use_javascript_animation'] == '0'){ echo ' data-ride="carousel"'; } ?> data-interval="<?php echo $atts['interval']; ?>">
			...
			if( count( $images ) > 1 ){
				if($atts['showcontrols'] === 'true' && $atts['twbs'] == '3') { ?>
					<a class="left carousel-control" href="#cptbc_<?php echo $id; ?>" data-slide="prev"><span class="sliderArrow"><img src="<?php bloginfo('template_directory'); ?>/img/arrow_left.png" alt="left arrow"></span></a>
					<a class="right carousel-control" href="#cptbc_<?php echo $id; ?>" data-slide="next"><span class="sliderArrow"><img src="<?php bloginfo('template_directory'); ?>/img/arrow_right.png" alt="right arrow"></span></a>
